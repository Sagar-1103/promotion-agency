...
export function BackgroundBeamsDemo() {
  return (
    <div className="h-[40rem] w-full dark:bg-neutral-950 bg-slate-50 relative flex flex-col items-center justify-center antialiased">
      <div className="max-w-3xl mx-auto p-4 text-center">
        <h1 className="relative z-10 text-lg py-3 md:text-7xl bg-clip-text text-transparent bg-gradient-to-b from-neutral-200 to-neutral-600 font-sans font-bold">
          Take Your YouTube Channel to New Heights
        </h1>
        <p className="text-neutral-500 max-w-lg mx-auto my-8 text-sm relative z-10">
